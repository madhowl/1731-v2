# Решения для практического занятия 18: Tkinter - элементы пользовательского интерфейса
...
# Решение задания 1: Основные виджеты ввода
class InputWidgetsSolution:
    """Решение для задания 1: Основные виджеты ввода"""
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Решение задания 1: Основные виджеты ввода")
...
# Решение задания 2: Кнопки и переключатели
class ButtonsAndTogglesSolution:
    """Решение для задания 2: Кнопки и переключатели"""
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Решение задания 2: Кнопки и переключатели")
        self.root.geometry("700x600")
        
        # Создаем фрейм для кнопок и переключателей
...
# Решение задания 3: Отображение информации
class InfoDisplaySolution:
    """Решение для задания 3: Отображение информации"""
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Решение задания 3: Отображение информации")
        ...
        self.canvas_widget.create_line(50, 150, 50, 150, fill="red", width=3)
...
# Решение задания 4: Навигационные элементы
class NavigationElementsSolution:
    """Решение для задания 4: Навигационные элементы"""
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Решение задания 4: Навигационные элементы")
...
# Решение задания 5: Комплексное приложение "Форма регистрации"
class RegistrationFormSolution:
    """Решение для задания 5: Комплексное приложение - форма регистрации"""
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Решение задания 5: Форма регистрации")
...
if __name__ == "__main__":
    print("=== Решения для практического занятия 18 ===")
    
    print("\n1. Решение задания 1: Основные виджеты ввода")
    input_solution = InputWidgetsSolution()
    # input_solution.run()  # Закомментировано для предотвращения автоматического запуска
    
    print("\n2. Решение задания 2: Кнопки и переключатели")
    buttons_solution = ButtonsAndTogglesSolution()
    # buttons_solution.run()  # Закомментировано
    
    print("\n3. Решение задания 3: Отображение информации")
    info_solution = InfoDisplaySolution()
    # info_solution.run()  # Закомментировано
    
    print("\n4. Решение задания 4: Навигационные элементы")
    nav_solution = NavigationElementsSolution()
    # nav_solution.run()  # Закомментировано
    
    print("\n5. Решение задания 5: Комплексное приложение (Форма регистрации)")
    reg_solution = RegistrationFormSolution()
    # reg_solution.run()  # Закомментировано
    
    print("\n6. Дополнительные примеры")
    advanced_solution = AdvancedWidgetExamples()
