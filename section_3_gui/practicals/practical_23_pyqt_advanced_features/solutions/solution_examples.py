# Решения для практического занятия 23: PyQt - продвинутые возможности
...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QLabel, QPushButton, 
                            ...
                            QMenu, QDesktopWidget, QGraphicsDropShadowEffect, QGraphicsProxyWidget)
...
# Решение задания 1: Пользовательские виджеты
class CustomWidgetSolution(QWidget):
    """Решение для задания 1: Пользовательские виджеты"""
...
class AnimatedProgressSolution(QWidget):
    """Решение для анимированного индикатора прогресса"""
    def __init__(self, parent=None):
        super().__init__(parent)
...
class CustomWidgetSolutionApp(QMainWindow):
    """Приложение с пользовательскими виджетами (решение)"""
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Решение задания 1: Пользовательские виджеты")
        ...
        self.custom_widget = CustomWidgetSolution()
        ...
        self.animated_progress = AnimatedProgressSolution()
        layout.addWidget(QLabel("Анимированный пользовательский прогресс бар:"))
        layout.addWidget(self.animated_progress)
        ...
        self.color_picker_btn = QPushButton("Выбрать цвет")
        self.color_picker_btn.clicked.connect(self.pick_color)
        additional_controls.addWidget(self.color_picker_btn)
        
        self.font_picker_btn = QPushButton("Выбрать шрифт")
        self.font_picker_btn.clicked.connect(self.pick_font)
        additional_controls.addWidget(self.font_picker_btn)
    ...
    def increment_progress(self):
        ...
        current_value = self.animated_progress.value
        self.animated_progress.set_value(current_value + 10)
    ...
    def pick_color(self):
        """Выбирает цвет для пользовательского виджета"""
    ...
    def pick_font(self):
        """Выбирает шрифт для приложения"""
        font, ok = QFontDialog.getFont()
        if ok:
            self.custom_widget.setFont(font)

# Решение задания 2: Работа с графикой
class GraphicsViewSolution(QMainWindow):
    """Решение для задания 2: Работа с графикой"""
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Решение задания 2: Работа с графикой")
    ...
    def add_graphic_elements(self):
        ...
        # Добавляем эллипсы
        for i in range(3):
            ellipse_item = QGraphicsEllipseItem(50, 150 + i*80, 80, 60)
...
# Решение задания 3: Многопоточность в GUI
class WorkerThreadSolution(QThread):
    """Рабочий поток для выполнения длительных операций (решение)"""
...
class ThreadingSolution(QMainWindow):
    """Решение для задания 3: Многопоточность в GUI"""
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Решение задания 3: Многопоточность в GUI")
        self.setGeometry(100, 100, 700, 500)
    ...
    def start_thread_operation(self):
        ...
        self.worker_thread = WorkerThreadSolution("Обработка данных", 2.0)  # 2 секунды
...
# Решение задания 4: Анимация и эффекты
class AnimationSolution(QMainWindow):
    """Решение для задания 4: Анимация и эффекты"""
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Решение задания 4: Анимация и эффекты")
...
# Решение задания 5: Комплексное приложение "Графический редактор"
...
class GraphicsEditorSolution(QMainWindow):
    """Решение для задания 5: Комплексное приложение - графический редактор"""
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Решение задания 5: Графический редактор")
...
if __name__ == "__main__":
    print("=== Решения для практического занятия 23 ===")
    
    print("\n1. Решение задания 1: Пользовательские виджеты")
    # app1 = QApplication(sys.argv)
    # basic_solution = BasicPyQtSolution()
    # basic_solution.show()
    # sys.exit(app1.exec_())  # Закомментировано для предотвращения автоматического запуска
    
    print("\n2. Решение задания 2: Работа с графикой")
    # app2 = QApplication(sys.argv)
    # graphics_solution = GraphicsViewSolution()
    # graphics_solution.show()
    # sys.exit(app2.exec_())  # Закомментировано
    
    print("\n3. Решение задания 3: Многопоточность в GUI")
    # app3 = QApplication(sys.argv)
    # threading_solution = ThreadingSolution()
    # threading_solution.show()
    # sys.exit(app3.exec_())  # Закомментировано
    
    print("\n4. Решение задания 4: Анимация и эффекты")
    # app4 = QApplication(sys.argv)
    # animation_solution = AnimationSolution()
    # animation_solution.show()
    # sys.exit(app4.exec_())  # Закомментировано
    
    print("\n5. Решение задания 5: Комплексное приложение (Графический редактор)")
    # app5 = QApplication(sys.argv)
    # editor_solution = GraphicsEditorSolution()
    # editor_solution.show()
