    ...
    def __init__(self):
        ...
        month_combo = ttk.Combobox(dob_frame, textvariable=self.dob_month, 
                                   values=["Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", 
                                          "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"], width=10)
        ...
        ttk.Radiobutton(gender_frame, text="Мужской", variable=self.gender_var, value="male").pack(side=tk.LEFT)
        ttk.Radiobutton(gender_frame, text="Женский", variable=self.gender_var, value="female").pack(side=tk.LEFT)
        
        # Согласие с условиями
        self.terms_var = tk.BooleanVar()
        ttk.Checkbutton(form_frame, text="Я согласен с условиями использования", variable=self.terms_var).pack(pady=10)
        
        # Кнопки
        button_frame = ttk.Frame(main_frame)
        button_frame.pack(pady=20)
        
        ttk.Button(button_frame, text="Зарегистрироваться", command=self.register).pack(side=tk.LEFT, padx=5)
...
def main():
    ...
    print("Решения для практического занятия 18: Tkinter - элементы пользовательского интерфейса")
    print("=" * 70)
    print("Выберите приложение для запуска:")
    print("1 - Основные виджеты ввода")
    print("2 - Кнопки и переключатели")
    print("3 - Отображение информации")
    print("4 - Навигационные элементы")
    print("5 - Форма регистрации")
    print("0 - Выход")
    print("=" * 70)
