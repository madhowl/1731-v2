# Практическое занятие 5: Работа с датой и временем в игровом контексте

## Цель занятия
Изучить возможности модуля datetime в Python для работы с датами и временем, включая форматирование, вычисления с датами, работу с часовыми поясами и календарные вычисления в игровом контексте.

## Задачи
1. Создать игровые системы, использующие дату и время (календарь событий, таймеры, расписание заданий)
2. Реализовать форматирование дат для игрового интерфейса
3. Применить вычисления с датами для систем отката (cooldown) и таймеров
4. Использовать работу с часовыми поясами для многопользовательских игровых событий
5. Реализовать календарные вычисления для игровых событий и расписания

## Ход работы

### 1. Основы работы с датами в игровом контексте

Создайте файл `game_datetime.py` и реализуйте следующие игровые системы:

#### Игровой таймер и отсчет времени
...
class GameTimer:
    """
    Класс для работы с игровым временем
    """
    def __init__(self):
    ...
    def get_elapsed_time(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - вычислите прошедшее время
        pass  # Замените на ваш код
    
    def format_elapsed_time(self):
        """
        Возвращает отформатированное время в виде строки (ЧЧ:ММ:СС)
        """
        # ВАШ КОД ЗДЕСЬ - отформатируйте время
        pass  # Замените на ваш код

# Пример использования:
# timer = GameTimer()
# elapsed_time = timer.get_elapsed_time()
# formatted_time = timer.format_elapsed_time()
```

#### Игровой календарь событий
...
class GameEvent:
    """
    Класс для представления игрового события
    """
    def __init__(self, name, start_time, duration_minutes=60, description=""):
        self.name = name
    ...
    def is_active(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - проверьте, активно ли событие
        pass  # Замените на ваш код
    
    def time_until_start(self):
        """
        Возвращает время до начала события
        """
        # ВАШ КОД ЗДЕСЬ - вычислите время до начала
        pass  # Замените на ваш код

# Пример использования:
# event = GameEvent("Турнир", datetime(2023, 10, 15, 18, 0), 120, "Еженедельный турнир")
# active = event.is_active()
```

---

## 1. Теоретическая часть: Создание игровых систем с использованием datetime

### Уровень 1 - Начальный

#### Задание 1.1: Создание системы отсчета игрового времени

Создайте класс для отслеживания игрового времени:
...
class GameTimeTracker:
    ...
    def get_current_time(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните текущее время
        pass  # Замените на ваш код
    ...
    def get_session_duration(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - вычислите длительность сессии
        pass  # Замените на ваш код
    ...
    def format_duration(self, duration):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - отформатируйте продолжительность
        pass  # Замените на ваш код
...
# formatted_duration = tracker.format_duration(session_duration)
```
...
Создайте систему регистрации игровых событий с метками времени:
...
class EventLogger:
    ...
    def log_event(self, event_type, player_name, details=""):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - зарегистрируйте событие с меткой времени
        pass  # Замените на ваш код
    ...
    def get_events_by_type(self, event_type):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните события заданного типа
        pass  # Замените на ваш код
    ...
    def get_events_by_timeframe(self, start_time, end_time):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните события в промежутке
        pass  # Замените на ваш код

# Пример использования:
# logger = EventLogger()
# logger.log_event("battle_won", "Игрок1", "Победа над драконом")
# battle_events = logger.get_events_by_type("battle_won")
```
...
Создайте систему управления временными ограничениями на использование способностей:
...
class CooldownManager:
    ...
    def use_ability(self, player_id, ability_name, cooldown_seconds):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - реализуйте логику использования способности
        pass  # Замените на ваш код
    ...
    def get_remaining_cooldown(self, player_id, ability_name):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - вычислите оставшееся время
        pass  # Замените на ваш код
    ...
    def is_ready(self, player_id, ability_name):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - проверьте готовность способности
        pass  # Замените на ваш код
...
Создайте систему календаря с возможностью установки напоминаний о событиях:
...
class GameCalendar:
    ...
    def add_event(self, name, start_time, duration_minutes=60, description=""):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - добавьте событие в календарь
        pass  # Замените на ваш код
    ...
    def set_reminder(self, event_id, reminder_minutes_before):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - установите напоминание
        pass  # Замените на ваш код
    ...
    def get_upcoming_events(self, timeframe_hours=24):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните предстоящие события
        pass  # Замените на ваш код
    ...
    def check_reminders(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - проверьте напоминания
        pass  # Замените на ваш код
...
Создайте систему ежедневных заданий с автоматическим обновлением:
...
class DailyQuestSystem:
    ...
    def refresh_daily_quests(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - обновите задания, если сменился день
        pass  # Замените на ваш код
    ...
    def assign_daily_quests(self, player_id):
        ...
        Args:
            player_id (str): ID игрока
        """
        # ВАШ КОД ЗДЕСЬ - назначьте задания игроку
        pass  # Замените на ваш код
    ...
    def complete_quest(self, player_id, quest_id):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - отметьте выполнение задания
        pass  # Замените на ваш код
    ...
    def get_player_quests(self, player_id):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните задания игрока
        pass  # Замените на ваш код
    ...
    def time_until_reset(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - вычислите время до сброса
        pass  # Замените на ваш код

# Пример использования:
# quest_system = DailyQuestSystem()
# quest_system.assign_daily_quests("player1")
# quests = quest_system.get_player_quests("player1")
```
...
Создайте систему для управления мероприятиями в разных часовых поясах:

```python
from datetime import datetime, timedelta
import pytz  # Используйте zoneinfo для Python 3.9+
...
class MultiTimeZoneEventManager:
    ...
    def create_event(self, name, start_time_utc, duration_hours, timezone_str, description=""):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - создайте мероприятие
        pass  # Замените на ваш код
    ...
    def get_event_time_in_timezone(self, event_id, timezone_str):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - конвертируйте время в нужный часовой пояс
        pass  # Замените на ваш код
    ...
    def get_events_for_user(self, user_timezone_str):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните мероприятия для пользователя
        pass  # Замените на ваш код
...
# )
# tournament_time_moscow = event_manager.get_event_time_in_timezone(event_id, "Europe/Moscow")
```
...
class MultiTimeZoneEventManager:
    ...
    def get_events_for_user(self, user_timezone_str):
        ...
        for event in self.events.values():
            ...
            event_time_user_tz = event['start_time_utc'].astimezone(user_tz)
            
            # Проверяем, что событие еще не прошло (или начинается в ближайшие 24 часа)
            if event_time_user_tz >= user_now - timedelta(hours=24):
                event_copy = event.copy()
                event_copy['start_time_user_tz'] = event_time_user_tz
...
Создайте систему достижений, которые зависят от времени:
...
class TimedAchievementSystem:
    ...
    def add_timed_achievement(self, name, description, time_requirement, requirement_type="playtime"):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - добавьте достижение
        pass  # Замените на ваш код
    ...
    def track_player_activity(self, player_id, activity_time):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - отследите активность
        pass  # Замените на ваш код
    ...
    def check_achievements(self, player_id):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - проверьте достижения
        pass  # Замените на ваш код

# Пример использования:
# timed_achs = TimedAchievementSystem()
# timed_achs.add_timed_achievement("Марафонец", "Играть 10 часов подряд", timedelta(hours=10), "playtime")
```
...
Создайте систему логирования с возможностью фильтрации по времени:
...
class TimeFilteredLogger:
    ...
    def log(self, level, message, player_id=None):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - запишите сообщение в лог
        pass  # Замените на ваш код
    ...
    def get_logs_by_timeframe(self, start_time, end_time):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните логи в промежутке
        pass  # Замените на ваш код
    ...
    def get_logs_by_level(self, level, hours_back=24):
        ...
        Returns:
            list: Список логов
        """
        # ВАШ КОД ЗДЕСЬ - верните логи заданного уровня
        pass  # Замените на ваш код

# Пример использования:
# logger = TimeFilteredLogger()
# logger.log("INFO", "Игрок вошел в игру", "player1")
# recent_errors = logger.get_logs_by_level("ERROR", 1)
```
...
Создайте систему расписания турниров:
...
class TournamentScheduler:
    ...
    def schedule_tournament(self, name, start_time, duration_minutes, registration_end_delta=None):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - спланируйте турнир
        pass  # Замените на ваш код
    ...
    def register_player(self, tournament_id, player_id):
        ...
        Args:
            ...
            player_id (str): ID игрока
        """
        # ВАШ КОД ЗДЕСЬ - зарегистрируйте игрока
        pass  # Замените на ваш код
    ...
    def get_upcoming_tournaments(self, hours_ahead=24):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните предстоящие турниры
        pass  # Замените на ваш код
    ...
    def is_registration_open(self, tournament_id):
        ...
        """
        # ВАШ КОД ЗДЕСТЬ - проверьте, открыта ли регистрация
        pass  # Замените на ваш код

# Пример использования:
# scheduler = TournamentScheduler()
# tournament_id = scheduler.schedule_tournament("Еженедельный турнир", datetime(2023, 10, 20, 19, 0), 120)
# scheduler.register_player(tournament_id, "player1")
```
...
Создайте систему ежедневных наград с календарем:
...
class DailyRewardSystem:
    ...
    def claim_daily_reward(self, player_id):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - реализуйте получение награды
        pass  # Замените на ваш код
    ...
    def get_current_streak(self, player_id):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните текущую серию
        pass  # Замените на ваш код
    ...
    def get_next_reward_info(self, player_id):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните информацию о следующей награде
        pass  # Замените на ваш код

# Пример использования:
# rewards = DailyRewardSystem()
# success, reward, streak = rewards.claim_daily_reward("player1")
```
...
Создайте систему игрового времени, которое может ускоряться или замедляться:
...
class GameTimeSystem:
    ...
    def get_game_time(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - вычислите игровое время
        pass  # Замените на ваш код
    ...
    def accelerate_time(self, multiplier):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - измените скорость времени
        pass  # Замените на ваш код
    ...
    def pause_resume(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - реализуйте паузу/возобновление
        pass  # Замените на ваш код
    ...
    def advance_time(self, time_delta):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - продвиньте время вперед
        pass  # Замените на ваш код

# Пример использования:
# game_time = GameTimeSystem(real_time_multiplier=0.5)  # Игровое время идет в 2 раза медленнее
# current_game_time = game_time.get_game_time()
```
...
Создайте комплексную систему управления игровыми событиями:
...
class ComprehensiveEventManager:
    ...
    def __init__(self):
        ...
        self.event_zones = {}  # События по игровым зонам
    ...
    def create_recurring_event(self, name, start_time, duration_minutes, recurrence_pattern, timezone_str, description=""):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - создайте повторяющееся событие
        pass  # Замените на ваш код
    ...
    def get_player_events(self, player_id, timeframe_days=7):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - верните события игрока
        pass  # Замените на ваш код
    ...
    def send_reminders(self):
        ...
        """
        # ВАШ КОД ЗДЕСЬ - реализуйте отправку уведомлений
        pass  # Замените на ваш код

# Пример использования:
# event_manager = ComprehensiveEventManager()
# event_id = event_manager.create_recurring_event(
#     "Еженедельный турнир", 
...
#     "Europe/Moscow"
# )
# event_manager.register_for_event(event_id, "player1", "Europe/Moscow")
```
...
### Задание 4: Система исторических событий

Реализуйте систему для отслеживания исторических событий в мире игры:
1. Создайте систему хронологии важных событий
2. Реализуйте возможность просмотра событий в хронологическом порядке
3. Добавьте фильтрацию событий по типу и периоду

### Задание 5: Система сезонных событий

Разработайте систему сезонных игровых событий:
1. Создайте расписание сезонных событий
2. Реализуйте автоматическое включение/выключение событий
3. Добавьте систему наград за участие в сезонных событиях

---

## Контрольные вопросы:
1. Какие классы предоставляет модуль datetime для работы с датами и временем?
2. Как работает арифметика с объектами datetime и timedelta?
3. Как правильно работать с часовыми поясами в Python?
4. Какие возможности дает библиотека pytz для работы с часовыми поясами?
5. Какие игровые системы наиболее эффективно использовать с datetime?